...
// Ya descarga el pdf en Retiro y Deposito, falta añadirlo a los demas modulos, el historial se puede sacar directo en historial con un OnLoad()...
function agregar() {

    var montoString = document.getElementById("monto").value;
    var monto = parseFloat(montoString);
    var montoArray = [];
    var descripcionArray = []; //deacuerdo al orden que se guarde cada monto se guardara una descripcion que solo existira internamente, en el caso del modulo de Deposito sera 'Deposito'
